export default {
  en: {
    ...
    'signin-description': 'Enter your email and password to sing in',
  ...
  pl: {
    ...
    'signin-description': 'Wpisz swój email i hasło, aby się zalogować',
    'password-label': 'Hasło',
    'remember-label': 'Zapamiętaj mnie',
  ...
  pt: {
    ...
    'signin-description': 'Digite seu e-mail e senha para cantar',
    'password-label': 'Senha',
    'remember-label': 'Lembre de mim',
